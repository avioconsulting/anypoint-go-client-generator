...
// SftpConfigAllOf struct for SftpConfigAllOf
type SftpConfigAllOf struct {
...
func (o SftpConfigAllOf) MarshalJSON() ([]byte, error) {
...
type NullableSftpConfigAllOf struct {
	value *SftpConfigAllOf
	isSet bool
}

func (v NullableSftpConfigAllOf) Get() *SftpConfigAllOf {
	return v.value
}

func (v *NullableSftpConfigAllOf) Set(val *SftpConfigAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSftpConfigAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSftpConfigAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSftpConfigAllOf(val *SftpConfigAllOf) *NullableSftpConfigAllOf {
	return &NullableSftpConfigAllOf{value: val, isSet: true}
}

func (v NullableSftpConfigAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSftpConfigAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// IdentifierAllOf struct for IdentifierAllOf
type IdentifierAllOf struct {
...
func (o IdentifierAllOf) MarshalJSON() ([]byte, error) {
...
type NullableIdentifierAllOf struct {
	value *IdentifierAllOf
	isSet bool
}

func (v NullableIdentifierAllOf) Get() *IdentifierAllOf {
	return v.value
}

func (v *NullableIdentifierAllOf) Set(val *IdentifierAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIdentifierAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIdentifierAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIdentifierAllOf(val *IdentifierAllOf) *NullableIdentifierAllOf {
	return &NullableIdentifierAllOf{value: val, isSet: true}
}

func (v NullableIdentifierAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIdentifierAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
